...
public class JwtHelper {
    ...
    //签名秘钥 自定义
    public static final String BASE64_SECRET = "base64sec";

    //超时毫秒数（默认30分钟）
    public static final int EXPIRE_SECOND = 1800000;
    ...
    public static String generateJWT(String userId, String userName, String... identities) {
        ...
        JwtBuilder builder = Jwts.builder().setHeader(headMap)
                 ...
                 */
                //加密后的客户编号
                .claim("userId", AESSecretUtil.encryptToStr(userId, DATA_KEY))
                //客户名称
        ...
        //添加Token过期时间
        if (EXPIRE_SECOND >= 0) {
            long expMillis = nowTimeMillis + EXPIRE_SECOND;
    ...
    public static String validateLogin(String jsonWebToken) {
        ...
        if (claims != null) {
            //解密客户编号
            String decryptUserId = AESSecretUtil.decryptToStr((String) claims.get("userId"), DATA_KEY);
            retMap = new HashMap<>();
            //加密后的客户编号
        ...
        return retMap != null ? JsonUtil.json(retMap) : null;
    }
